    ...
    return (
      <>
        ...
        <div className="sidebar-container">
          <button
            onClick={async () => {
              await this.getPresetDates(0, -1, 0, 0, false, false, false, false)
            }}
          >
            Yesterday
          </button>
        ...
        <div className="sidebar-container">
          <button
            onClick={async () => {
              await this.getPresetDates(0, 0, 0, 1, false, false, false, false)
            }}
          >
            Today
          </button>
        ...
        <div className="sidebar-container">
          <button
            onClick={async () => {
              await this.getPresetDates(0, -7, 0, 0, false, false, true, false)
            }}
          >
            Last Week
          </button>
        ...
        <div className="sidebar-container">
          <button
            onClick={async () => {
              await this.getPresetDates(0, 0, 0, 7, false, false, true, false)
            }}
          >
            This Week
          </button>
        ...
        <div className="sidebar-container">
          <button
            onClick={async () => {
              await this.getPresetDates(-1, 0, 0, 0, false, false, false, true)
            }}
          >
            Last Month
          </button>
        ...
        <div className="sidebar-container">
          <button
            onClick={async () => {
              await this.getPresetDates(0, 0, 1, 0, false, false, false, true)
            }}
          >
            This Month
          </button>
        ...
        <div className="sidebar-container">
          <button
            onClick={async () => {
              await this.getPresetDates(-3, 0, 0, 0, false, true, false, true)
            }}
          >
            Last Quarter
          </button>
        ...
        <div className="sidebar-container">
          <button
            onClick={async () => {
              await this.getPresetDates(0, 0, 3, 0, false, true, false, true)
            }}
          >
            This Quarter
          </button>
        ...
        <div className="sidebar-container">
          <button
            onClick={async () => {
              await this.getPresetDates(-12, 0, 0, 0, true, false, false, true)
            }}
          >
            Last Year
          </button>
        ...
        <div className="sidebar-container">
          <button
            onClick={async () => {
              await this.getPresetDates(0, 0, 12, 0, true, false, false, true)
            }}
          >
            This Year
          </button>
